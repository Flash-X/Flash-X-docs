...
|  ``setup_call``     | shortcut expansion                            |
+---------------------+-----------------------------------------------+
|                     | contains the list of libraries and their      |
| ``setup_libraries`` | arguments used to generate the executable     |
+---------------------+-----------------------------------------------+
|                     | contains the list of all units which were     |
|  ``setup_units``    | included in the current setup                 |
+---------------------+-----------------------------------------------+
...
| ``setup_params``    | ``setup``                                     |
+---------------------+-----------------------------------------------+
|                     | contains the list of variables, fluxes        |
|  ``setup_vars``     | with their descriptions.                      |
+---------------------+-----------------------------------------------+
|                     |                                               |
+---------------------+-----------------------------------------------+
