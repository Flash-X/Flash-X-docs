...
-  A copy of the |flashx| source code distribution. To obtain a copy of
   the source code, please visit https://github.com/|flashx| and request
   access to the |flashx| repository as a collaborator.

-  A Fcompiler, a C compiler, and a C++ compiler, and Python 3 or above.
...
Neumann) boundary conditions (set via the
``[{\tt x}{\tt y}][{\tt l}{\tt r}]_boundary_type`` parameters).
